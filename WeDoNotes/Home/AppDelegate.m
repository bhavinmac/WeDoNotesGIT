...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [Parse setApplicationId:@"M2qamfA7Y6IMy5cfmm2QlbM8oOF0FyKMFMOITWWt" clientKey:@"PVG8zceX4vMtD30sR9h310jCNxvTJv2xZ7RF5t5y"];
    
    // If you are using Facebook, uncomment and fill in with your Facebook App Id:
    [PFFacebookUtils initializeWithApplicationId:@"140607889450292"];
    // ****************************************************************************
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WeDoNotes" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[[UtilityClass sharedObject] applicationDocumentsDirectoryURL] URLByAppendingPathComponent:@"WeDoNotes.sqlite"];
